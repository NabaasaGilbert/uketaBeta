import LoginForm from "../../../components/coaches/forgotpassword/ForgotPasswordFormEl";
...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <div>
        <LoginForm onSubmit={loginHandler} loginResponse={responseMessage} loading={loading} />
      </div>
    </>
  );
}
