import ResetPasswordForm from "../../../components/coaches/resetPassword/ResetPassword";
...
export default function ResetPassword() {
  ...
  return (
    <>
      <Head>
        <title>Reset Password - Coach | Uketa Learning - Unlock, Understand, Uplift</title>
        <meta
          name="description"
      ...
      <div>
        <ResetPasswordForm onSubmit={loginHandler} loginResponse={responseMessage} loading={loading} />
      </div>
    </>
  );
}
