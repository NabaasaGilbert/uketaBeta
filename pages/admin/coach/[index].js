    ...
    const widget = window.cloudinary.createUploadWidget(
      ...
      (error, result) => {
        if (
          ...
          axios
            .post(`/api/instructor/updateInstructorSignature`, payload)
            .then((res) => {
              setIsSaving(false);
              setSuccessMsg("Signature has been updated successfully.");
              setTimeout(() => {
                setSuccessMsg("");
          ...
          <div className="py-5 mt-5 container">
            ...
            <div className="d-lg-flex d-xl-flex d-md-flex d-block p-2">
              <span className="col-lg-3 col-xl-3 col-md-4 col-12 p-2">
                ...
                <div>
                  {userData.signature ? (
                    <img className="img-fluid" src={userData?.signature} />
                  ) : (
                    <div className="alert alert-danger text-center">
                      Please add coach signature
                    </div>
                  )}
