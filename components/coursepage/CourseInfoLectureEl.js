...
export default function CourseInfoLectureEl(props) {
    ...
    <>
      <Row className={classes.CourseContent}>
        {!course ? (
          ...
          <>
            <Col sm={12} md={12} lg={7} xl={9} ref={aboutRef}>
                  ...
                  <>
                    {blogs.map((elem) => {
                      return (
                        ...
                        >
                          <li key={course.id} className="fancySidebarItem">
                            <img src={elem.image} className="w-25"/>
